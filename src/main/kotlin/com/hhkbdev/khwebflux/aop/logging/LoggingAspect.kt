package com.hhkbdev.khwebflux.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.hhkbdev.khwebflux.repository..*)" +
            " || within(com.hhkbdev.khwebflux.service..*)" +
            " || within(com.hhkbdev.khwebflux.web.rest..*)"
    )
