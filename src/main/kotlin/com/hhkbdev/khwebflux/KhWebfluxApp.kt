...
import com.hhkbdev.khwebflux.config.ApplicationProperties
import com.hhkbdev.khwebflux.config.CRLFLogConverter
...
class KhWebfluxApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes khWebflux.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<KhWebfluxApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(KhWebfluxApp::class.java)
